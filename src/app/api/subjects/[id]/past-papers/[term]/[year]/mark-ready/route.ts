...
import { markQuestionsReadyForPaper } from "@/lib/questions";
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  try {
    ...
    const updatedCount = await markQuestionsReadyForPaper(
    ...
    const message =
      error instanceof Error ? error.message : "Failed to mark questions as ready.";
